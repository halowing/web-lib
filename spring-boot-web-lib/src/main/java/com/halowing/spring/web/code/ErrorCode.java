...
public class ErrorCode {
	...
	public static final String INVALID_AUTHORIZATION	=	"error.auth.invalidAuthority";
	public static final String INVALID_AUTHENTICATION	=	"error.auth.invalidAuthentication";
